    ...
    <div className="flex justify-between mt-4">
      <div className="text-left">
       ...
       <div className="text-right ">
        <p className="text-gray-300 ">IMDb Rating: <span className="font-semibold">{film.rating}/10</span></p>
        <p className="text-gray-300 ">Rank: <span className="font-semibold w-[100%]">{film.rank}/100</span></p>
      </div>
    </div>
  );
};
